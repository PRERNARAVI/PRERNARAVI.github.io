      ...
      >
        ...
        <Row>
                <Container responsive="true">
                    ...
                    <div style={fontFormat} responsive="true">
                    <div style={{color: "#E9C46A", fontSize: 18}}>Problem Space:</div>
                        <Image width="40%" src="https://www.indiaeducation.net/imagesvr_ce/475/MOOC.jpg" style={{float: "right", paddingLeft: "5px"}}/>
                    <div responsive="true">
                    Following the initial proliferation of Massive Open Online Courses (MOOCs), a more recent trend has emerged toward offering "Affordable Degrees at Scale" or "Large, Internet Mediated Asynchronous Degrees". 
                    In this research, I have set out to understand this space: the range in tuition costs for these programs, the variety of admissions standards, and the types of assessments used to evaluate these non-traditional students. 
                    However, these programs may not be as new as we initially perceived: similarly-priced online programs have existed from traditional universities for years. 
                    My aim is to explore two questions: what are these new degrees at scale, and how do they actually differ from traditional programs? 
                    To draw up a comprehensive lens of the online learning space, I will be conducting an exhaustive data collation initiative across multiple US educational institutions offering MOOC-based as well as non-MOOC-based graduate degrees which will provide vital qualitative feeds for this valuable study. 
                    I will then explore the patterns in tuition, admissions requirements, and syllabus information. 
                    This will help inform trends identified in MOOC-based degrees, and attempt to answer the question: what makes these programs different from non-MOOC-based online programs of the past? 
                    </div>
                    <div responsive="true">
                    I am conducting this study under the guidance of <a href="https://www.davidjoyner.net/" style={{textAlign: "left", color: "#E9C46A", fontSize: 15}}><u>Dr. David Joyner</u></a> at the Georgia Tech LucyLabs. 
                    </div>
                        <br></br>
