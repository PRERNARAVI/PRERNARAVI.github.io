          ...
          {/* <Image style={background} responsive="true"  src={BlackOne} fluid="true"/> */}
            ...
            <Container className="about-me">
                ...
                <Container className="about-me-text">
                    ...
                    I am a second-year Computer Science PhD student at <a style={{color: "#E9C46A"}}href="https://www.csail.mit.edu/" >MIT CSAIL</a> advised by <a style={{color: "#E9C46A"}}href="https://en.wikipedia.org/wiki/Hal_Abelson">Dr. Hal Abelson</a> and <a style={{color: "#E9C46A"}}href="https://en.wikipedia.org/wiki/David_Karger"> Dr. David Karger</a>. 
                    My research focuses on designing AI powered educational tools, curricula, and learning experiences that foster equity and creativity.
                    ...
                    As an interdisciplinary scholar, I engage in ethnographic fieldwork, participatory design, system development, and evaluation.
                    ...
                    You can find my CV [Last updated: July 2024] on this website. 
                    </div>
                    <br></br>
                    <div>
                        Latest Updates: 
                        <ul>
                        <li> 7/2024 – I was selected as the Teaching Development Fellow for MIT EECS from MIT's Teaching and Learning Lab for 2024-2025! </li>
                        ...
                        <li> 7/2024 – I will be giving a talk on our K12 Data Literacy work at the UNESCO Paris Headquarters from September 2-5 during their <a style={{color: "#E9C46A"}} href="https://www.unesco.org/en/weeks/digital-learning">Digital Learning Week!</a></li>
                        ...
                        <li> 4/2024 – I will be serving as the Diversity and Inclusion Chair for <a style={{color: "#E9C46A"}} href="https://uist.acm.org/2024/organizers/">UIST 2024.</a></li> 
