  ...
  return (
    <div responsive="true">
      ...
      <Nav className="navbar-options-format">
        ...
        <Nav.Link><NavLink style={{color: "#b3b3b3", textDecoration: 'none' }} activeStyle={{fontWeight: "bold", color: "#E9C46A", textDecoration: 'none' }} exact to="/publications">Publications & Service</NavLink></Nav.Link>
